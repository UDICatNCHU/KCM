...
# Extract 維基的XML
cd ../;python2 WikiPreProcessor.py -wiki bz2/zhwiki-20161120-pages-articles1.xml.bz2 -o cht -l=$(lang) ;python2 WikiPreProcessor.py -wiki bz2/zhwiki-20161120-pages-articles2.xml.bz2 -o cht -l=$(lang) ;python2 WikiPreProcessor.py -wiki bz2/zhwiki-20161120-pages-articles3.xml.bz2 -o cht -l=$(lang) ;python2 WikiPreProcessor.py -wiki bz2/zhwiki-20161120-pages-articles4.xml.bz2 -o cht -l=$(lang)
